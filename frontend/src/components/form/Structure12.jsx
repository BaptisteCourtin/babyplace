    ...
    <div className="structure12 page-left">
      <div className="pageContent">
        ...
        {structure === "creche" && (
          <div>
            <h5>
              Nombre de professionnels de la petite enfance employés par votre
              structure
            </h5>
            <p>
              Vous compris, combien de personnes travaillent-elles dans votre
              structure ?
            </p>
            <div className="inputContainer">
              <label htmlFor="nbEmployes">
                <input
                  ...
                  name="nbEmployes"
                  value={nbEmployes}
                  onChange={(e) => updateFields({ nbEmployes: e.target.value })}
                />
                professionnel(s)
              </label>
            </div>
          ...
          <div className="inputContainer">
            <label htmlFor="maxPlaces">
              <input
                ...
                name="maxPlaces"
                value={maxPlaces}
                onChange={(e) => updateFields({ maxPlaces: e.target.value })}
              />
              place(s)
            </label>
          </div>
        ...
        <div>
          ...
          <p>
            Disposez vous de restriction d'agrément ? Indiquez le nombre{" "}
          ...
          <div className="inputContainer">
            ...
            <label htmlFor="maxHandi">
              <input
                ...
                name="maxHandi"
                value={maxHandi}
                onChange={(e) => updateFields({ maxHandi: e.target.value })}
              />
              maximum
            </label>
          </div>
          <div className="inputContainer">
            ...
            <label htmlFor="max18Mois">
              <input
                ...
                name="max18Mois"
                value={max18Mois}
                onChange={(e) => updateFields({ max18Mois: e.target.value })}
              />
              maximum
            </label>
          </div>
          <div className="inputContainer">
            ...
            <label htmlFor="maxNuit">
              <input
                ...
                name="maxNuit"
                value={maxNuit}
                onChange={(e) => updateFields({ maxNuit: e.target.value })}
              />
              maximum
            </label>
          </div>
...
Structure12.propTypes = {
  nbEmployes: Proptypes.node,
  maxPlaces: Proptypes.node,
  maxHandi: Proptypes.node,
  max18Mois: Proptypes.node,
  maxNuit: Proptypes.node,
