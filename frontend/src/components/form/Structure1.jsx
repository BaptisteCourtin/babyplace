        ...
        <div>
            <div>
                ...
                <div className="typeContainer">
                    <button type="button" onClick={() => setTypeStructure("creche")}>Crèche</button>
                    <button type="button" onClick={() => setTypeStructure("assmat")}>Assistante maternelle</button>
                </div>
            </div>
            ...
            <div>
                ...
                />
                <p>Les parents n’obtiendront l’adresse exacte qu’après avoir effectué la réservation</p>
            </div>
            <div>
