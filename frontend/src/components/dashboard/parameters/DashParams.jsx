  ...
  return (
    <div className="dashParams">
      ...
      <details className="dashParamsDocs">
        ...
        <p className="dashParamsFormats">
          Formats acceptés: <span>pdf / jpg / jpeg / png</span>
        </p>
        {userType === "assMat" ? (
          <ul>
            <li>
              <div className="dashParamsDocsContainer">
                ...
                <input
                  ...
                  onChange={() => {
                    uploadDoc("docPmi", "docPmiData", docPmiRef, "structure");
                  }}
                />
              </div>
            ...
            <li>
              ...
              <a href={docIdentite} target="_blank" rel="noopener noreferrer">
                Fichier actuel
              </a>
            </li>
            <li>
            ...
            <li>
              ...
              <a href={docJustifDom} target="_blank" rel="noopener noreferrer">
                Fichier actuel
              </a>
            </li>
            <li>
              ...
              <a href={docDiplome} target="_blank" rel="noopener noreferrer">
                Fichier actuel
              </a>
            </li>
            <li>
              ...
              <a href={docRespCivile} target="_blank" rel="noopener noreferrer">
                Fichier actuel
              </a>
            </li>
            <li>
              ...
              <a href={docAssAuto} target="_blank" rel="noopener noreferrer">
                Fichier actuel
              </a>
            </li>
          </ul>
