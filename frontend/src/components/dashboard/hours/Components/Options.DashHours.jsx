...
OptionsDashHours.propTypes = {
  ...
  indemn1: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  setIndemn1: PropTypes.func.isRequired,
  indemn2: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  setIndemn2: PropTypes.func.isRequired,
  indemn3: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
