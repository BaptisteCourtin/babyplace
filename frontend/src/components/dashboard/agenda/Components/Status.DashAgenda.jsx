...
function StatusDashAgenda({ calendar, structureId, date, updateStatusOpen, maxPlaces, places, setPlaces, setCalendarIndex, updatePlaces, updateStatusClose, fullDate }) {
    return (
        <>
            {calendar
