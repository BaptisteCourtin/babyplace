      ...
      <section id="about-us">
        ...
        <div className="descriptionContainer">
          <div className="descriptionTxt">
            <p>
              Depuis 2022, l’agence Dave Warehouse propose ses services pour
              tous les projets de création de site et de référencement naturel.
              Implantée depuis sa créations à Nantes, Dave Warehouse peut vous
              accueillir pour améliorer nos échanges.
            </p>
            <p>
              {" "}
              Nous vivons le mouvement perpétuel. Nous aimons l’évolution,
              matière à réflexion et à innovation. Nous faisons notre métier
              avec enthousiasme et engagement. L’adaptation est l’essence même
              de notre longévité. Notre adaptation est une force et une capacité
